...
export function CategoryIllustration({ category, className }: { category: string; className?: string }) {
  return (
    ...
    >
      <defs>
        <linearGradient id="voltra-accent" x1="0" y1="0" x2="1" y2="1">
...
function getIllustrationBody(category: string) {
  switch (category) {
    case "Passive Components":
      return (
        <g fill="none" stroke="url(#voltra-accent)" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round">
    ...
    case "Sensors":
      return (
        <g fill="none" stroke="url(#voltra-accent)" strokeWidth="4" strokeLinecap="round">
